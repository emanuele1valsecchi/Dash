...
class RunForegroundService {
  ...
  static Future<bool> ensureNotificationPermission() async {
    ...
    try {
      ...
      if (!status.isGranted) {
        debugPrint('RunForegroundService: notifications denied — '
            'background tracking will not survive the screen going off');
      }
      return status.isGranted;
    } catch (e) {
      debugPrint('RunForegroundService: permission request failed — $e');
      return false;
    }
  }
